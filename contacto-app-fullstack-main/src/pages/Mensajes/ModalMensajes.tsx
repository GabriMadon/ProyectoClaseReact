...
export const ModalMensaje = ({ onClose, mensaje }: Props) => {
  ...
  // Renderiza el modal para agregar o editar un mensaje
  // que incluye un formulario con un textarea y botones para cancelar o guardar
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          {/* Botones para cancelar o guardar el mensaje */}
